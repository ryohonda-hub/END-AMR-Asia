...
DIR_ARG="${DIR_WORKING}/3.ARGI/Asia300" # RGI results of contigs
DIR_PROF="${DIR_WORKING}/4.ARGI_profile/Asia300" # ARG profile of contigs
DIR_16S="${DIR_WORKING}/5.16S_taxonomy/Asia300" # 16S taxonomy of contigs
DIR_SUM="${DIR_WORKING}/6.summary300" # ARG-host table
