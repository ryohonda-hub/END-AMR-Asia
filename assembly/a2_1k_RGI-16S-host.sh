...
DIR_CTG="${DIR_WORKING}/2.megahit/Asia1000" 
...
DIR_ARG="${DIR_WORKING}/3.ARGI/Asia1000" # RGI results of contigs
DIR_PROF="${DIR_WORKING}/4.ARGI_profile/Asia1000" # ARG profile of contigs
DIR_16S="${DIR_WORKING}/5.16S_taxonomy/Asia1000" # 16S taxonomy of contigs
DIR_SUM="${DIR_WORKING}/6.summary1000" # ARG-host table
