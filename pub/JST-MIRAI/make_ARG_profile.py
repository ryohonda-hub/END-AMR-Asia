#==============================================================================
# make_ARG_profile.py / created by Ryo Honda (END-AMR-Asia)
#==============================================================================
...
for i, gene in df_count.iterrows():
    ...
    df_count.at[i, 'gene symbol'] = re.split('\|', sseqid)[5] # get gene symbol
...
file_out=args[3].rstrip('/')+"/"+file_out.rstrip('.count')+".ARG_profile.tsv"
